import { CardHeader, CardBody, Image, Divider } from "@nextui-org/react";
  ...
  return (
    <>
      <CardHeader className="flex flex-row justify-between items-center">
        <div className="text-2xl font-semibold test-secondary">
          Edit Profile
        </div>
        <DogPhotoUpload />
      </CardHeader>
      <Divider />
      <CardBody>
        <DogPhotos photos={photos} editing={true} mainImageUrl={dog?.image} />
      </CardBody>
    </>
  );
}
